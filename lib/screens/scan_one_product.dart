...
class ScanOneProduct extends StatefulWidget {
  final Product? product;
  final int jumlah;

  const ScanOneProduct({Key? key, required this.product, required this.jumlah}) : super(key: key);

  @override
  _ScanOneProductState createState() => _ScanOneProductState();
}

class _ScanOneProductState extends State<ScanOneProduct> {
  ...
  void scan() async{
    ...
    array_of_orders.add({
      ...
      'harga' : widget.product!.harga_jual,
    ...
    print(body);
    if (body['success']) {
      showSnackBar('Produk berhasil discan! Silahkan lanjutkan proses checkout');
